...
```{r Q5 check balance}
plotMeanDiff(checkBalance(dt, confounders, 'wt'), 'Propensity Score Model: Logistic Regression')  
plotMeanDiff(checkBalance(dt, confounders, 'w_probit'), 'Propensity Score Model: Probit Regression')  
plotMeanDiff(checkBalance(dt, confounders, 'w_logit_no_rep'), 'Matching Method: Logistic w/o Replacement')  
plotMeanDiff(checkBalance(dt, confounders, 'wt.mh'), 'Matching Method: Mahalanobis')
plotMeanDiff(checkBalance(dt, confounders, 'wt_k2'), 'Matching Method: Nearest Neighbor (k=2)')

# Plot SD Ratios
temp = rbind(
  checkBalance(dt, confounders, 'wt'),
  checkBalance(dt, confounders, 'w_probit'),
  checkBalance(dt, confounders, 'w_logit_no_rep'),
  checkBalance(dt, confounders, 'wt.mh'),
  checkBalance(dt, confounders, 'wt_k2')
)
