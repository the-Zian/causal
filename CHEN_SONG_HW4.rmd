...
plotMeanDiff = function(balance_object, title) {
...
ps1.bal <- checkBalance(dt, confounders, 'wt')
prob.bal <- checkBalance(dt, confounders, 'w_probit')
full.bal <- checkBalance(dt, confounders, 'w_full')
norep.bal <- checkBalance(dt, confounders, 'w_logit_no_rep')
rf.bal <- checkBalance(dt, confounders, 'w_rf')
mh.bal <- checkBalance(dt, confounders, 'wt.mh')


plotMeanDiff(ps1.bal, 'First Logistic Model')
plotMeanDiff(prob.bal, 'First Probit Model')
plotMeanDiff(full.bal, 'Full Probit Model')
plotMeanDiff(norep.bal, 'First Logistic Model, No replacement')
plotMeanDiff(mh.bal, 'Mahalanobis Matching')
```
...
model_bals <- list(ps1.bal, prob.bal, full.bal, norep.bal, mh.bal)
model_names <- c('Logistic', 'Probit', 'Probit (full)', 'Logistic (no replacement)', 'Mahalanobis')
```

`r compareBalance(model_bals, model_names, 6)`

`r compareBalance(model_bals, model_names, 8)`
