...
cbind(dt$wt_mh[291:310],zz$weights[291:310])
```
...
\texttt{ANSWER:}  
For children who participated in the IDHP intervention, their IQ scores at age 3 were `r round(mod6.out[1], 1)` points higher than had they not participated in the intervention.
...
\texttt{ANSWER:}  
A group of children who participated in the IHDP intervention will expect, on average, an 11.54 point increase in their age 3 IQ scores compared to a group of children who did not participate in the intervention, controlling for all other covariates.
