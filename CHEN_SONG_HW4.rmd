...
model_bals <- list(logit.bal, probit.bal, logit_nr.bal, mh.bal, mk2.bal)
model_names <- c('Logistic', 'Probit', 'Logistic (no replacement)', 'Mahalanobis Matching', 'K=2 Nearest Neighbors')
```
